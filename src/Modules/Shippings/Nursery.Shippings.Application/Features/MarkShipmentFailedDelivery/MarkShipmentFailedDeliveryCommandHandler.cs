...
public class MarkShipmentFailedDeliveryCommandHandler(IShipmentRepository repository) : ICommandHandler<MarkShipmentFailedDeliveryCommand, bool>
{
    public async Task<bool> Handle(MarkShipmentFailedDeliveryCommand request, CancellationToken ct)
    {
